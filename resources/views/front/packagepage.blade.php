    ...
    <div class="container-fluid place">
        <div class="container p-4">
            <div class="row">
                <div class="col-md-8">
                   <div class="card mb-4">
                        <img src="{{ asset('user/packageimg') }}/{{ $packages->image }}" alt="{{ $packages->title }}" class="img-fluid img-responsive w-100 card-img" style="opacity: 0.9;">
                        <div class="container title-h1 pb-1 card-img-overlay d-flex flex-column justify-content-end my-3">{{ $packages->title }}</div>
                   </div>
                        <div class="tabs">
                            <button class="tablink" onclick="openPage('about', this, '#fff')" id="defaultOpen">About</button>
                            ...
                            <div id="itinerary" class="tabcontent">
                              <p>
                                <h5>Duration:</h5>&nbsp; {!! $packages->duration !!}<br><br>
                                <h5>Itinerary:</h5> <br> {!! $packages->itinerary !!}<br><br>
                                <h5>Price:</h5>&nbsp;{!! $packages->price !!}<br><br>
                                <h5>Price Includes:</h5><br>{!! $packages->priceinclude !!}<br><br>
                              </p>
                            </div>
                                ...
                                <div class="row pb-3">
                                    <div class="col-5">
                                        <a href="{{route('front.destination', $destination->id)}}">
                                            <img src="{{asset('user/destinationimg')}}/{{$destination->image}}" class="card-img img-fluid img-responsive">
                                        </a>
                                    </div>
